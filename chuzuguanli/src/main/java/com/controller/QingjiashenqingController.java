...
public class QingjiashenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,QingjiashenqingEntity qingjiashenqing,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date qingjiariqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date qingjiariqiend,
        ...
        EntityWrapper<QingjiashenqingEntity> ew = new EntityWrapper<QingjiashenqingEntity>();
                if(qingjiariqistart!=null) ew.ge("qingjiariqi", qingjiariqistart);
                if(qingjiariqiend!=null) ew.le("qingjiariqi", qingjiariqiend);

	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="体温" prop="tiwen">
					<el-input v-model="ruleForm.tiwen" placeholder="体温" clearable  :readonly="ro.tiwen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="体温" prop="tiwen">
					<el-input v-model="ruleForm.tiwen" placeholder="体温" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="健康状态" prop="jiankangzhuangtai">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="健康状态" prop="jiankangzhuangtai">

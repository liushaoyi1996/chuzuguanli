	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingdanbianhao" label="订单编号" prop="dingdanbianhao">
					<el-input v-model="ruleForm.dingdanbianhao" placeholder="订单编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'" label="用户名" prop="yonghuming">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.yonghuming" label="用户名" prop="yonghuming">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="登记时间" prop="dengjishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					var json = data.data;
					if(json.chuzuchebianhao!=''&&json.chuzuchebianhao && this.$storage.get("role")!="管理员"){
						this.ruleForm.chuzuchebianhao = json.chuzuchebianhao
						this.ro.chuzuchebianhao = true;
					}
					if(json.chuzuchepinpai!=''&&json.chuzuchepinpai && this.$storage.get("role")!="管理员"){
						this.ruleForm.chuzuchepinpai = json.chuzuchepinpai
						this.ro.chuzuchepinpai = true;
					}
			...
			yonghumingChange () {
				this.$http({
					url: `follow/chengke/yonghuming?columnValue=`+ this.ruleForm.yonghuming,
					method: "get"
				}).then(({ data }) => {
					if (data && data.code === 0) {
						if(data.data.chengkexingming){
							this.ruleForm.chengkexingming = data.data.chengkexingming
						}
					} else {
						this.$message.error(data.msg);
					}

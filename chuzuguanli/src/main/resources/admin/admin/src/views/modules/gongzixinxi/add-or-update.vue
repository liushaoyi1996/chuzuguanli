	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="日营运" prop="riyingyun">
					<el-input v-model="ruleForm.riyingyun" placeholder="日营运" clearable  :readonly="ro.riyingyun"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="日营运" prop="riyingyun">
					<el-input v-model="ruleForm.riyingyun" placeholder="日营运" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="营运里程" prop="yingyunlicheng">
					<el-input v-model="ruleForm.yingyunlicheng" placeholder="营运里程" clearable  :readonly="ro.yingyunlicheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="营运里程" prop="yingyunlicheng">
					<el-input v-model="ruleForm.yingyunlicheng" placeholder="营运里程" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="营运收入" prop="yingyunshouru">
					<el-input v-model="ruleForm.yingyunshouru" placeholder="营运收入" clearable  :readonly="ro.yingyunshouru"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="营运收入" prop="yingyunshouru">
					<el-input v-model="ruleForm.yingyunshouru" placeholder="营运收入" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="工资收入" prop="gongzishouru">
					<el-input v-model="ruleForm.gongzishouru" placeholder="工资收入" clearable  :readonly="ro.gongzishouru"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="工资收入" prop="gongzishouru">
					<el-input v-model="ruleForm.gongzishouru" placeholder="工资收入" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='riyingyun'){
							this.ruleForm.riyingyun = obj[o];
							this.ro.riyingyun = true;
							continue;
						}
						if(o=='yingyunlicheng'){
							this.ruleForm.yingyunlicheng = obj[o];
							this.ro.yingyunlicheng = true;
							continue;
						}
						if(o=='yingyunshouru'){
							this.ruleForm.yingyunshouru = obj[o];
							this.ro.yingyunshouru = true;
							continue;
						}
						if(o=='gongzishouru'){
							this.ruleForm.gongzishouru = obj[o];
							this.ro.gongzishouru = true;
							continue;
						}
						if(o=='dengjishijian'){

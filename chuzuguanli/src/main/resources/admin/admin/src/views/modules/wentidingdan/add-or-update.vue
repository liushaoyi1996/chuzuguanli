<template>
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="订单编号" prop="dingdanbianhao">
					<el-input v-model="ruleForm.dingdanbianhao" placeholder="订单编号" clearable  :readonly="ro.dingdanbianhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="订单编号" prop="dingdanbianhao">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="乘客姓名" prop="chengkexingming">
					<el-input v-model="ruleForm.chengkexingming" placeholder="乘客姓名" clearable  :readonly="ro.chengkexingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="乘客姓名" prop="chengkexingming">
					<el-input v-model="ruleForm.chengkexingming" placeholder="乘客姓名" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="乘车点" prop="chengchedian">
					<el-input v-model="ruleForm.chengchedian" placeholder="乘车点" clearable  :readonly="ro.chengchedian"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="乘车点" prop="chengchedian">
					<el-input v-model="ruleForm.chengchedian" placeholder="乘车点" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="目的地" prop="mudedi">
					<el-input v-model="ruleForm.mudedi" placeholder="目的地" clearable  :readonly="ro.mudedi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="目的地" prop="mudedi">
					<el-input v-model="ruleForm.mudedi" placeholder="目的地" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="时长" prop="shizhang">
					<el-input v-model="ruleForm.shizhang" placeholder="时长" clearable  :readonly="ro.shizhang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="时长" prop="shizhang">
					<el-input v-model="ruleForm.shizhang" placeholder="时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="里程" prop="licheng">
					<el-input v-model="ruleForm.licheng" placeholder="里程" clearable  :readonly="ro.licheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="里程" prop="licheng">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="总费用" prop="zongfeiyong">
					<el-input v-model="ruleForm.zongfeiyong" placeholder="总费用" clearable  :readonly="ro.zongfeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="总费用" prop="zongfeiyong">
					<el-input v-model="ruleForm.zongfeiyong" placeholder="总费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="反馈时间" prop="fankuishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.fankuishijian" label="反馈时间" prop="fankuishijian">
					<el-input v-model="ruleForm.fankuishijian" placeholder="反馈时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="情况反馈" prop="qingkuangfankui">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="情况反馈"
					  v-model="ruleForm.qingkuangfankui" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else-if="ruleForm.qingkuangfankui" label="情况反馈" prop="qingkuangfankui">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.qingkuangfankui}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chengchedian'){
							this.ruleForm.chengchedian = obj[o];
							this.ro.chengchedian = true;
							continue;
						}
						if(o=='mudedi'){
						...
						if(o=='qingkuangfankui'){
							this.ruleForm.qingkuangfankui = obj[o];
							this.ro.qingkuangfankui = true;
							continue;
						}
				}
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(json.chengkexingming!=''&&json.chengkexingming && this.$storage.get("role")!="管理员"){
						this.ruleForm.chengkexingming = json.chengkexingming
						this.ro.chengkexingming = true;
					}
				} else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wentidingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wentidingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();

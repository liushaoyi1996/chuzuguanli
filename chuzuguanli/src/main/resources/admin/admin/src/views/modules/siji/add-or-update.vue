	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="身份证" prop="shenfenzheng">
					<el-input v-model="ruleForm.shenfenzheng" placeholder="身份证" clearable  :readonly="ro.shenfenzheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="身份证" prop="shenfenzheng">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="驾驶证类型" prop="jiashizhengleixing">
					<el-select :disabled="ro.jiashizhengleixing" v-model="ruleForm.jiashizhengleixing" placeholder="请选择驾驶证类型" >
						<el-option
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="驾驶证类型" prop="jiashizhengleixing">
					<el-input v-model="ruleForm.jiashizhengleixing"
						placeholder="驾驶证类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="驾驶证号码" prop="jiashizhenghaoma">
					<el-input v-model="ruleForm.jiashizhenghaoma" placeholder="驾驶证号码" clearable  :readonly="ro.jiashizhenghaoma"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="驾驶证号码" prop="jiashizhenghaoma">
					<el-input v-model="ruleForm.jiashizhenghaoma" placeholder="驾驶证号码" readonly></el-input>
				</el-form-item>

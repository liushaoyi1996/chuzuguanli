...
<div :style='{"border":"1px solid #9ce3b5","padding":"20px","boxShadow":"0px 2px 6px #ccc,inset 0px 0px 600px 0px #e0f8e8","margin":"20px auto 0","borderRadius":"16px","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}'  label="驾驶证类型" prop="jiashizhengleixing">
            <el-select v-model="ruleForm.jiashizhengleixing" placeholder="请选择驾驶证类型" >
              <el-option
                  v-for="(item,index) in jiashizhengleixingOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="驾驶证号码" prop="jiashizhenghaoma">
            <el-input v-model="ruleForm.jiashizhenghaoma" 
                placeholder="驾驶证号码" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="头像" prop="touxiang">
            <file-upload
            tip="点击上传头像"
            action="file/upload"
            :limit="3"
          ...
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="出租车编号" prop="chuzuchebianhao">
            <el-input v-model="ruleForm.chuzuchebianhao" 
                placeholder="出租车编号" clearable readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"border":"0px solid #dfdfdf","padding":"10px","boxShadow":"0px 0px 0px #eee","margin":"0 0 8px 0","borderRadius":"8px","background":"none"}' label="出租车品牌" prop="chuzuchepinpai">
            <el-input v-model="ruleForm.chuzuchepinpai" 
                placeholder="出租车品牌" clearable readonly></el-input>
          </el-form-item>
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='jiashizhenghaoma'){
              this.ruleForm.jiashizhenghaoma = obj[o];
              continue;
            }
            if(o=='touxiang'){
        ...
        this.jiashizhengleixingOptions = "A,B,C".split(',')
      },

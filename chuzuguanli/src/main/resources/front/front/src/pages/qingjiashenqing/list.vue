...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","margin":"20px auto 0","borderColor":"#9cc0e4","alignItems":"center","display":"flex","borderRadius":"4px","flexWrap":"wrap","background":"#e6eff8","borderWidth":"1px","width":"1200px","borderStyle":"solid","height":"auto","order":"2"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>请假日期</div>
        <el-date-picker 
          v-model="timeRange"
          type="daterange"
          ...
          range-separator="至"
          start-placeholder="请假日期起始"
          end-placeholder="请假日期结束"
	  ...
	  <el-button v-if="isAuth('qingjiashenqing','新增')" :style='{"cursor":"pointer","border":"0px solid #db961f","padding":"0px 15px","boxShadow":"0px 0px 0px #f8a412","margin":"0px 10px 0 0","color":"#fff","outline":"none","borderRadius":"4px","background":"#08b344","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/qingjiashenqingAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.timeRange.length > 0) {
          searchWhere.qingjiariqistart = this.timeRange[0];
          searchWhere.qingjiariqiend = this.timeRange[1];
        }
        params['sort'] = 'shenqingshijian';
        params['order'] = 'desc';
	      params['sfsh'] = '是';
        this.$http.get('qingjiashenqing/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/qingjiashenqingDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
